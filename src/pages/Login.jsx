...
export const Login = () => {
    ...
    const login = () => {
        setCurrentUser({ perfil: "trabajador" })
            ...
            <div className="container py-5">
                <div className="row d-flex justify-content-end align-items-end">
                    ...
                    <div className="col-12 col-md-5 col-lg-5 col-xl-5">
                        <div className="card c-rosa" style={{ borderRadius: '1rem', border: '2px solid' }}>
                            <div className="card-body p-5 text-center">
                                <div className="mb-md-5 mt-md-4 pb-5">
                                    ...
                                    <button className="btn bg-rosa-oscuro btn-lg px-5 c-blanco" type="submit" onClick={login}>Ingresar</button>
                                    <p className="small mt-5 pb-lg-2 c-rosa">¿Olvidó su contraseña? Contáctese directamente con el administrador.</p>
                                </div>
                            </div>
                        </div>
                    </div>
